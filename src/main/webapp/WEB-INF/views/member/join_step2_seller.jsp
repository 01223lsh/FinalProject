...
//체크박스가 체크되었는지 판별
	$(document).ready(function(e) {	
		...
		$(location).attr("href","/member/join_step3_seller");
				...
				{
					alert("펀딩·스토어 서비스 서포터 이용 약관에 동의하셔야 합니다.");
					$('.check04').focus();
					return;
				}
			}
            ...
            <ul class="join_box">
                ...
                <li class="checkBox check01">
                    <ul class="clearfix">
                        <li>이용약관, 개인정보 수집 및 이용,
                            펀딩·스토어 서비스 서포터 이용약관 안내에 모두 동의합니다.</li>
                ...
                <li class="checkBox check02">
                    <ul class="clearfix">
                        ...
                        <li id="agreement1">이용약관 동의(필수)</li>
                    </ul>
                ...
                <li class="checkBox check03">
                    <ul class="clearfix">
                        ...
                        <li id="agreement2">개인정보 수집 및 이용에 대한 안내(필수)</li>
                    </ul>
                ...
                <li class="checkBox check04">
                    <ul class="clearfix">
                        ...
                        <li id="agreement3">펀딩·스토어 서비스 서포터 이용약관(필수)</li>
                    </ul>
...
<!--                 <li><span class="fpmgBt2">다음단계로</span></li> 동의  -->
				<li><input type="button" id="fpmgBt2" value="다음단계로" ></li>
            </ul>
        </form>
