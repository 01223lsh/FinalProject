...
<div>
	<c:forEach items="${noticeFile }" var="i">
	<div class="imgBox" id="imgBox${i.fileNo}">
		<img src="/noticeimg/${i.fileStorage}" class="imgfile" id="photo${i.fileNo}">
		<input type="button" class="removebtn" onclick="removephoto(${i.fileNo})" value="x"/>
		<input type="hidden" value="${i.fileNo}" name="fileNolist" class="photo${i.fileNo}"/>
	</div>
	</c:forEach>
</div>
