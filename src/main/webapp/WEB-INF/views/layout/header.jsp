...
<!-- 	<ul style="list-style-type: none;"> -->
			...
			<c:when test="${empty login }">
				<button type="button" class="btn nav-login_h_button"><a href="/member/join_step1" id="login">JOIN</a></button><button type="button" class="btn nav-login_h_button"><a href="/member/login" id="login">LOGIN</a></button>
			</c:when>
...
<!-- 				<a href="#" >로그아웃</a> | <a href="#">관리자 페이지</a> | <a href="/chat/room/enter/1">채팅</a> -->
			...
			<c:when test="${sessionScope.login eq true && sessionScope.grade eq '1'}">
				<button type="button" class="btn nav-login_h_button"><a href="/apply/category">CREATE PROJECT</a></button>
				<button type="button" class="btn  nav-login_h_button"><a href="/member/logout">LOGOUT</a></button><button type="button" class="btn nav-login_h_button"><a href="/mypage/mypagemain">MYPAGE</a></button>
			...
			<c:otherwise>
				<button type="button" class="btn nav-login_h_button"><a href="/member/logout">LOGOUT</a>
				</button><button type="button" class="btn nav-login_h_button"><a href="/mypage/mypagemain">MYPAGE</a></button>
				<button class="project_button"  onclick="alertList()"><ion-icon size="large" name="notifications-outline"></ion-icon><span id="unread"></span></button>
				<div id="alertView" class="header_alert active">
					<!-- 동적생성 -->
				</div>
