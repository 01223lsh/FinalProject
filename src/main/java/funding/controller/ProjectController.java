...
public class ProjectController {
	...
	@RequestMapping(value = "/project/listsearch", method = RequestMethod.GET)
	public String list(Pagination pagination, Model model) {
		log.info("[/project/listsearch][GET]");
	...
	public String view(Project viewProject, Model model, HttpSession session) {
		log.info("/project/view - {}", viewProject);
		...
		// 게시글 조회
		viewProject = projectService.view(viewProject);
