...
public class ApprovedPaging {
	...
	public ApprovedPaging() { }
	
	public ApprovedPaging(int totalCount, int curPage) {
	...
	public ApprovedPaging(int totalCount) {
		setTotalCount(totalCount);
		
		makePaging();
	}
	
	public ApprovedPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public ApprovedPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
